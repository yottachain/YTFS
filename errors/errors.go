...
var (
	...
	ErrStorageSerialNumber       = errors.New("YTFS: storage serial number mismatch")
	ErrCapProofLineFull          = errors.New("YTFS: cap proof cur line full")
	ErrCapProofWriteDataOverflow = errors.New("YTFS: cap proof cur pos write data overflow")
	ErrCapProofMetaErr           = errors.New("YTFS: cap proof meta data error(kv nums mismatch)")
)
